 ...
 */
	Configure::write('Security.salt', '15826d4fe87a1a2290c5add9592ec291880929ed');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '666233666238616331653636393530');
