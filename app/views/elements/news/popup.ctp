...
<div id="Popup">  
	...
	<div id="contenedor">
		<div id="h_1">
			...
			<div id="txt">
				<p>Arrancamos la etapa de prueba, abierta a todos los usuarios! Cualquier comentario tuyo es muy importante para nosotros, al pie de la página se encuentra el link para contactarnos.</p>
