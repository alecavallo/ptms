...
<div id="contenedor">
	<div id="h_1">
		...
		<div id="txt"><p>Esta secci&oacute;n se habilitar&aacute; en:</p></div>
		<!-- CONTDOWN -->
		<div id="holder">
			<div id="timer">
				<div id="note"></div>
				<div id="countdown">
					...
					<div id="title">
						...
						<div class="title" style="position: absolute; top: 36px; left: 156px">MINS</div>
						<div class="title" style="position: absolute; top: 36px; left: 211px">SEGS</div>
					</div>
				</div>
			</div>
		</div>
